    ...
    SmartBanner.prototype = {
      ...
      , create: function() {
            ...
            if(this.options.url)
              ...
              if(this.notAndroid) {
                link = "https://play.google.com/store/apps/details?id=com.locket.matterhorn";
              }
            }

            var banner = '<div id="smartbanner" class="'+this.type+'"><div class="sb-container"><a href="#" class="sb-close"><img src="../../images/close.png" style="width: 17px; height: 17px;"></a><span class="sb-icon"></span><div class="sb-info"><strong>'+this.title+'</strong><span>'+this.author+'</span><span style="margin-top: 2px; margin-bottom: 2px; margin-left: -2px;"><img src="../../images/rating.png" style="height: 10px;"></span><span>'+inStore+'</span></div><a href="'+link+'" class="sb-button"><span>'+this.options.button+'</span></a></div></div>';
      ...
      , close: function(e) {
            ...
            window._gaq.push(['_trackEvent', 'button', 'click', 'Close Window']);
        }
      ...
      , install: function(e) {
            ...
            window._gaq.push(['_trackEvent', 'button', 'click', 'Download']);
        }
